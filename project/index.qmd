...
![](media/praxis-logo.png){width="300" fig-align="center"}


## About prAxIs
![](media/banner-light.png)

**prAxIs** is a [Large Teaching and Learning Enhancement Fund (TLEF)](https://tlef.ubc.ca/) project started at the [University of British Columbia](https://www.ubc.ca/) in 2022 that seeks ... **Change here**
