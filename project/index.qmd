...
# Welcome to prAxIs! {.test}
![](media/praxis-badge.png){width="300" fig-align="center"}


## About prAxIs
![](media/banner.png)

**prAxIs**  is a [Large Teaching and Learning Enhancement Fund (TLEF)](https://tlef.ubc.ca/) project started at the [University of British Columbia](https://www.ubc.ca/) in 2025 that seeks to help to create learning resources for various UBC arts classes using machine learning and AI.  **change this / add not final**

Based at UBC’s [**Vancouver School of Economics**](https://economics.ubc.ca/), our team consists of **faculty** and **students** (at all levels) working in partnership to develop **hands-on learning modules** that explore the real-world applications of economic theory using machine learning and AI. 
...
::: {.column width="55%"}
### <span style="color:#000000" > For Learners </span>
These modules cover four different class so far. Topics include:
...
Launching the notebooks in a JupyterHub will allow you to run the code for yourself, complete the exercises and get automatic feedback throughout your learning. Happy learning! 
:::
...
::: {.column width="40%"}
### <span style="color:#000000" > For Educators </span>
