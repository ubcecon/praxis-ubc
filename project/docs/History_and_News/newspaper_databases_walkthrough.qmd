...
![Searching "chinese exclusion" in the Chronicling America collection](media/chinese_exclusion_ca.png){width=90%}
...
![Search results, with the matched terms highlighted on each page](media/highlighted_match2.png){width=90%}
...
![Downloading the page as a PDF](media/downloading_page.png){width=90%}
...
![Viewing the OCR text of the page](media/view_ocr.png){width=90%}
...
![The OCR text view](media/download_ocr.png){width=90%}
...
![Searching in Trove's digitized newspapers](media/trove.png){width=90%}
...
![Narrowing Trove results with the filter panel](media/trove_filter.png){width=90%}
...
![The page image (left) compared to its OCR text (right)](media/compare_text_trove.png){width=90%}
...
![Our article tracker](media/tracker_sheet.png){width=95%}
