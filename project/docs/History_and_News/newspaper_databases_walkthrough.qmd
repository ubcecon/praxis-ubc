...
![Searching "chinese exclusion" in the Chronicling America collection](media/chinese_exclusion_search1.png){width=90%}
...
![Search results, with the matched terms highlighted on each page](media/higlighted_match2.png){width=90%}
...
![Narrowing results using the filter panel](media/filter33.png){width=90%}
...
![Downloading the page as a PDF](media/2.4.jpeg){width=90%}
...
![Viewing the OCR text of the page](media/2.5.jpeg){width=90%}
...
![The OCR text view](media/2.5.2.png){width=90%}
...
![Searching in Trove's digitized newspapers](media/Trove_search1.png){width=90%}
...
![Narrowing Trove results with the filter panel](media/Trove_narrowing_results2.png){width=90%}
...
![The page image (left) compared to its OCR text (right)](media/ImageTextComparison.png){width=90%}
...
![Our article tracker](media/Spreadsheet.png){width=95%}
...
- [Text Analysis Overview](https://ubcecon.github.io/praxis-ubc/docs/text_analysis/text_analysis.html) — the natural next step. A survey of text analysis approaches, beginning with hand-coded qualitative analysis and building up from there. This is the basis for the lecture portion of our session.
