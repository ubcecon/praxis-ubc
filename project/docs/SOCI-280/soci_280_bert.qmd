...
format:
  html:
    output-file: soci_280_bert.html
    embed-resources: true
    self-contained-math: true
    code-fold: true
    code-summary: "Show the code"
  revealjs:
    output-file: soci_280_bert-slides.html
    theme: white
    scrollable: true
    smaller: true
    slide-number: true
...
2. Click on your profile picture (top right) → and click **Settings**.
3. Scroll down to the Legacy API Credentials section at the bottom → click **Create Legacy API Key**.
