...
file_path = r'datasets\ZA8825_v1-0-0.dta' #path for the dataset
...
![Map of the 2023 Polish Parlimentary elections (For Sejm and Senate)](media/2023_poland.jpg) 
...
Let's continue our analysis by looking at the Parental Seperation Variable and seeing if we can infer any trends or interesting findings like before. 
...
We can see that there is no difference between left and right leaning regions with the Left-leaning regions having a seperation percentage of 66.69% and the right leaning regions having one of 69.57%. So the cause is not political leaning. Let us also repeat this analysis for the United States.   
