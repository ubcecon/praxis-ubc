...
We can see the degree of each node by running `dict(G.degree())`. This creates a dictionary of key-value pairs for our network, where each key is the name of the node and the value is its respective degree. 
