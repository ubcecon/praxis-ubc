...
Lets look at two of these communities in more detail, we will look at one average sized one and one large one. We can compare these communities to the ones in the KINMATRIX Dataset. Pay attention and look for differences. 
...
Lets now map these values to real dynasty names. We will do this by looking at the c_dynasty and c_dy variables which represents real dynasty names. 
...
Open mobility periods produced more diverse networks with varied connection patterns as oppoised to closed elite periods where networks were much more exclusive, dense and isolated. 
