...
We now have more quantifiable metrics for our visualizations. Let's continue our analysis with finding which dynasties these communities are primarily from. Every node in this dataset is a real person in Chinese history so it will be very interesting to "put a face to the name."
