...
The leftovers are approaching zero, because the learner reads the training outcomes back to use, memorizing the noise not true predictive signal. With nothing left to regress, the estimate collapses to -0.10, nowhere near the true 1.
