---
title: "Teaching AI for the Disciplines: PrAxIs at UBC"
...
![It's me!](img/cropped_2.png){fig-alt="Jonathan's headshot" width="550px"}
...
* Associate Professor of Teaching, Vancouver School of Economics, UBC
* Undergraduate Director (Curriculum and Students)
* Co-Principal Investigator, PrAxIs Project
...
* AI is overwhelming sold in higher education as a way to "save time" and "automate tasks" for students and faculty.
* Or: it's a way to "learn better" or "more efficienctly" by using it as a tool for studying, writing, etc.

> But: these are _educational_ uses for AI.  They are not about _economics_ or _sociology_ or our disciplines.  They are about using AI as a general-purpose tool, not as a tool for _doing_ economics.

---

If you look at how actual economists and researchers are using AI tools, the transformative applications are _not_ about writing emails faster.

* The really powerful applications are about using AI as a way to do better economics (or sociology, or history), not just to do economics faster.
* We call this **constructing knowledge** since it means using AI in a way that a discipline recognizes as new information.

This was what we wanted to address.

## Our pitch: Have you ever...
...
In this workshop, I have two main goals:

1.  To **demonstrate** how we can use AI tools in this constructive way, through demonstrating implementations of two modules from our PrAxIs project.
2.  To share the **pedagogical approach** we took in designing these modules, and help you brainstorm how you could apply it in your own courses and disciplines.
...
1.  **Scale**: AI tools that increase the scale of what an individual can do, through automation or machine assistance. 
2.  **Perspective**: AI tools that give us new perspectives that are fundamentally different from human perspectives, allowing us to study new kinds of relationships.
...
We highlight both of these kinds of applications, but think (2) is more important.
...
![Political Economy - [https://tinyurl.com/cTreeDemo2](https://tinyurl.com/cTreeDemo2)](img/qr_pol.png){fig-alt="QR code for Political Economy module" width="360"}

![Data in Economics QR code - [https://tinyurl.com/ctreeDemo1](https://tinyurl.com/ctreeDemo1)](img/qr_llm.png){fig-alt="QR code for Data in Economics module" width="360"}
