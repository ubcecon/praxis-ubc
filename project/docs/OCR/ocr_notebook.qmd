...
We can very clearly visually see the way in which EasyOCR is reading the text. Green boxes represent high confidence while blue are lower confidence (we do not see any red as there is no very low confidence regions).
...
As for the second image (the horoscope) it is in English so it will be easier to understand. The output is messy with obvious issues, but it is in very old English and can be rougly understood. 
