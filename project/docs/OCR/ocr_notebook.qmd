...
Noise in images is "the random, unwanted variation in brightness or color information in digital images, appearing as a grainy, speckled, or mottled texture." An example is ![Noise Example](data/pre_processing_example/noise_example.png)
