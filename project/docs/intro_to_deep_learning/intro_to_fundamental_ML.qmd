...
In 2012, everything changed with a breakthrough called AlexNet. It was a large neural network that could look at pictures and recognize objects (like cats, dogs and cars etc.) better than anything before. It was taught how to recognize images very efficiently which allowed it to see millions of images and learn how to recognize patterns, stitch them together, and make predictions.
...
This is a plot of social media followers vs engagement. Let's say you want to predict engagement based on followers.
...
Though here, it is just a simple example/demonstration. You cannot draw a line to separate the 2 populations. 
...
plt.title("Urban vs Rural Areas Population\nDecision Boundary using a Neural Network")
plt.tight_layout()
plt.show()
```
...
This is a very difficult problem. We only have glimpses into what neural networks learn and how they internally represent things. 
