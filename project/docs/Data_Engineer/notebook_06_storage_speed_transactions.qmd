...
- **Back to Notebook 5:** the schema said what may be stored; this notebook was how it is stored. The all-or-nothing behaviour behind Notebook 5's refused load now has its name and its mechanism, the atomic transaction.
