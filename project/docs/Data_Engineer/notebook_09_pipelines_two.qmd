...
flowchart TB
    ...
    ARC1 --> ARC2 --> ARC3 --> ARC4
    style NB9 fill:#c8e6c9,stroke:#2e7d32,stroke-width:3px
```
...
Let's take a step back from our poison data; this last section is different. What have we been doing by hand all notebook? We manually set `run_month[0]`, we called `run_pipeline`, we remembered that September and October were fine, that November was corrupted and then repaired. We acted as a **scheduler**. 
