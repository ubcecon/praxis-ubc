...
Quarto is a strong improvement over R Markdown and supports multiple languages.  However, it is still in development and is more complicated.  **We recommend Quarto for development and offline use**^[We use Quarto to develop the prAxIs project.].
...
## Developing your own Notebooks for Teaching CHANGE
...
While we think that teaching using a JupyterHub is the best option, that may not always be desired or possible.  If you want to use prAxIs notebooks, or similar teaching tools, without a JupyterHub you have two main options:
