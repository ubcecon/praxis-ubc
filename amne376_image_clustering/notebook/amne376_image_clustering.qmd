...
In this notebook, we explore a dataset of photographs collected from ***Richter's Kouroi (1942)***.
...
Here, we will create a visualization that shows the last feature layer of the 4 images after convolution, what commonality and difference did you notice from the extracted features in this layer?
```{python}
model = VGG16(weights='imagenet', include_top=False)
