...
```{python}
#| ExecuteTime: {end_time: '2025-06-07T03:31:44.832758Z', start_time: '2025-06-07T03:31:44.444760Z'}
#| editable: true
...
```{python}
#| ExecuteTime: {end_time: '2025-06-07T03:32:11.494698Z', start_time: '2025-06-07T03:32:11.401274Z'}
#| editable: true
#| slideshow: {slide_type: ''}
#| tags: []
...
```{python}
#| ExecuteTime: {end_time: '2025-06-07T03:32:17.304576Z', start_time: '2025-06-07T03:32:17.227866Z'}
#| editable: true
#| slideshow: {slide_type: ''}
#| tags: []
degree = 2
...
```{python}
#| ExecuteTime: {end_time: '2025-06-07T03:32:21.135498Z', start_time: '2025-06-07T03:32:21.064632Z'}
degree = 16
...
```{python}
#| ExecuteTime: {end_time: '2025-06-07T03:32:26.028737Z', start_time: '2025-06-07T03:32:25.964079Z'}
plt.figure(figsize=(8, 5))
plt.scatter(x=x, y=y, s=100, alpha=0.6, label='Data')
...
- The contour plot is like looking at the loss landscale from above. 
...
So we can see here that the we need to minimize the error. The way to do that is to go down. 

- What is the error here? how is it quantified?

- How do we go down? what if we have more than 1-2 parameters?

The error is quantified as $$Error = (\text{Actual Value} - \text{Predicted Value})^2$$

In reality you sum over your data and take the average $$Error = \frac{1}{\text{Number of data points}} \times \text{Sum Over Each} \ (\text{Actual Value} - \text{Predicted Value})^2$$

This is the error that we want to minimize on our training data. 
