---
title: ECON 227 - How Does Large Language Models Work?
date: '2025-08-04'
author: _prAxIs UBC Team <br>Krishaant Pathman, Yash Mali, Kaiyan Zhang_
...
We are using the `yfinance` package to get real stock price data directly from Yahoo Finance. The function below helps us download historical stock prices and compute the daily percentage change in the stock's closing price. To make sure our results are replicaable, this data has been saved as a `.csv` file "data/NVDA_snapshot.csv"
...
def create_plot(combined_df, forecast_mean, forecast_ci, forecast_index):
    ...
    sentiment_std = (combined_df['lagged_sentiment'] - combined_df['lagged_sentiment'].mean()) \
                    / combined_df['lagged_sentiment'].std()
