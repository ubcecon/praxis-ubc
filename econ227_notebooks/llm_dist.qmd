...
flowchart TB
  ...
  subgraph S4["bob went to buy some milk"]
    direction LR
    B4[bob] --> W4[went] --> T4[to] --> B4b[buy] --> S4b[some] --> M4[LLM] --> P4[next?]
    style M4 fill:#ADD8E6,stroke:#333,stroke-width:2px
    style P4 fill:#FFD700,stroke:#333,stroke-width:2px,font-weight:bold
  end
