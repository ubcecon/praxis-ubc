...
---
title: ""
author: "Irene Berezin, Alex Ronczewski, Krishaant Pathmanathan"
format: revealjs
scrollable: true
smaller: true
---
...
Imagine you have a giant pile of stories, surveys or interviews. Researchers first make a **list of buckets** (this list is called a *codebook*). Then one by one, they **read the text and put each piece into the right bucket**. Examples of buckets can be any topic, for instance, money, family, politics, etc.
...
###### The Modern Way: Crowdsourcing  

Hand-coding takes a long time. So now, people sometimes ask **regular peoples** who aren't expertly trained to help.  
...
::: callout-important
**Watch outs**
- Models can “hallucinate” (make things up). This is because they generate text by predicting likely word patterns, not by checking facts, so when information is missing they produce fluent but sometimes incorrect answers.
...
## 2.4.2.3 Local Models vs. Cloud Models 
**The choice:**  
