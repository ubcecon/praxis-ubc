...
That's not to say don't remove stopwords/stem/lemmatize. It's useful for some methods but not for others (LDA). Just dont do so blindly--  think very carefully about *why* you doing so and how it affects your model. 
